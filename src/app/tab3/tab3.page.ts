...
export class Tab3Page {
  ...
  getOink() {
    ...
    if (this.isInApp) {
      setTimeout(()=>{
        this.nativeHttp.get('https://www.googleapis.com/customsearch/v1?q=baby%20sheep&start=' + date + '&searchType=image&num=1&key=AIzaSyAPvDEdOoGeldbbmVWShXguFmWFaX79DI8&cx=013483737079049266941:mzydshy4xwi', {}, {})
          .then(data => {
      ...
      setTimeout(()=>{
        this.http.get('https://www.googleapis.com/customsearch/v1?q=baby%20sheep&start=' + date + '&searchType=image&num=1&key=AIzaSyAPvDEdOoGeldbbmVWShXguFmWFaX79DI8&cx=013483737079049266941:mzydshy4xwi').subscribe(
        result => {
